...
import FocusTimerWidget from '@/components/analytics/FocusTimerWidget';
    ...
    <div className="min-h-screen bg-[var(--deep-space)] text-white selection:bg-brick selection:text-white">
      ...
      <div className="pt-28 pb-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 animate-fade-in">
          <div className="md:col-span-2 p-8 rounded-3xl bg-gradient-to-r from-slate-900 to-slate-800 border border-slate-700 relative overflow-hidden group">
          ...
          <div className="md:col-span-1 p-1 rounded-3xl bg-gradient-to-b from-slate-800 to-slate-900/50 border border-slate-700/50 flex flex-col items-center justify-center relative backdrop-blur-sm h-full min-h-[200px]">
